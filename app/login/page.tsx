...
import { ArrowLeft, CheckCircle2, Lock, Mail, Building, User, Briefcase, ArrowRight, ShieldCheck } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload =
      tab === "login"
        ...
        : { name, email, title, company, password, provider: "email" };
        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl sm:text-3xl font-extrabold text-navy">
              {tab === "login" ? "Welcome back to LeadIntellect" : "Create your account"}
            </h1>
                ...
                <div className="flex items-center justify-between mb-1">
                  ...
                  {tab === "login" && (
                    <button
                      ...
                      className="text-[11px] text-teal-dark hover:underline"
                    >
                      Forgot?
                    </button>
                  )}
          ...
          <div className="mt-6 flex items-center justify-center gap-2 text-xs text-text-muted">
            ...
            <span>256-Bit SSL Encrypted &middot; SOC-2 Type II Certified</span>
          </div>
        </div>
      </main>
